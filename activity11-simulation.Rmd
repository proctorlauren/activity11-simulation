...
```{r}
rexp_samp_1000 <- tibble(
  values = rexp(n = 1000, rate = .02)
)
mean(rexp_samp_1000$values)
sd(rexp_samp_1000$values)
```
```{r}
rexp_samp_30 <- tibble(
  values = rexp(n = 30, rate = .02)
)
mean(rexp_samp_30$values)
sd(rexp_samp_30$values)
```
